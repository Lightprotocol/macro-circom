...
template AppTransaction(nrMaxSigners, baseVariables, levels, nIns, nOuts, feeAsset, indexFeeAsset, indexPublicAsset, nAssets, nInAssets, nOutAssets) {
    ...
    connectingHasher.inputs[2] <== integrity_hash;
...
*/  
    ...
    */
    ...
    {
        threshold,
        (signerPubkeysX[nrMaxSigners], signerPubkeysY[nrMaxSigners]),
        // norm would be x, y, z
    }
    */
