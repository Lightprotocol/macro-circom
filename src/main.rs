...
// - create integration test for generated circom code
...
fn main() -> Result<(), AnyhowError> {
    ...
    // parse .light file
    let (mut instance, checkedUtxos, remainingContent) = parse(contents.clone())?;

    // start code generation
    let (circom_main_code, circom_code, rust_autogenerated_accounts_code) =
        generate_code(&mut instance, checkedUtxos, remainingContent);
