pub const PART_ONE: &str = "use crate::processor::TransactionsConfig;
...
pub const PART_TWO: &str = "/// Executes light transaction with state created in the first instruction.
#[derive(Accounts)]
